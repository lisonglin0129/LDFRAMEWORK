...
class Worker
{
    ...
    /**
     * 日志目录，默认在根目录下，与Applications同级
     * 可以手动设置
     * 例如 Worker::$logFile = '/tmp/worker.log';
     * @var mixed
     */
     ...
     * 统计的内容包括 启动的时间戳及每组worker进程的退出次数及退出状态码
     * @var array
     */
    ...
    {
        echo "\033[1A\n\033[K-----------------------\033[47;30m STFRAMWORK \033[0m-----------------------------\n\033[0m";
        echo 'STFRAMWORK version:1.0'  , "          PHP version:",PHP_VERSION,"\n";
    ...
    protected static function reinstallSignal()
    {
        ...
        self::$globalEvent->add(SIGINT, EventInterface::EV_SIGNAL, array('Worker', 'signalHandler'));
        //  uninstall  reload signal handler
        self::$globalEvent->add(SIGUSR1, EventInterface::EV_SIGNAL,array('Worker', 'signalHandler'));
        // uninstall  status signal handler
        self::$globalEvent->add(SIGUSR2, EventInterface::EV_SIGNAL, array('Worker', 'signalHandler'));
    }
    ...
    protected static function writeStatisticsToStatusFile()
    {
        ...
        if(self::$_masterPid === posix_getpid())
        {
            ...
            file_put_contents(self::$_statisticsFile, 'STFRAMWORK version:' . Worker::VERSION . "          PHP version:".PHP_VERSION."\n", FILE_APPEND);
